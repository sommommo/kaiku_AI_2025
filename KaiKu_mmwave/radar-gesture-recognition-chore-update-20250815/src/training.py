...
TRAINING_DATA_DIR = os.path.join("data", "processed_data", "test_dataset.npz")
VAL_DATA_DIR = os.path.join("data", "processed_data", "test_dataset.npz")
WINDOW_SIZE = 30
STEP_SIZE = 1
BATCH_SIZE = 32
EPOCHS = 50
LEARNING_RATE = 1e-4
NUM_CLASSES = 6  # Background, Down, Left, Right, Tap, Up111
...
gesture_types = ['background', 'down', 'left', 'right', 'tap', 'up']
...
def load_data(data_path):
    ...
    Returns:
        ...
        y (np.array): Array of shape (num_samples, 6) containing soft labels.
    """
    ...
    ground_truths = data['ground_truths']  # (frames, 6)
